...
**************************************************
* Developer   : Ibrahim El Gibran
* Company     : IegCode
* Release     : Januari 2024
* Update      : -
* Website     : ibrahimelgibran.com
* E-mail      : ibrahimelgibran17@gmail.com
* WhatsApp    : +62-858-7607-6005
-->
...
<head>
    ...
    <!-- Favicon icon -->
    <link rel="shortcut icon" href="assets/img/ieg.png" type="image/x-icon">
    ...
    <footer class="footer mt-auto py-4">
        <div class="container">
            ...
            <div class="copyright text-center mb-2 mb-md-0" >
                &copy; 2024 - <a href="https://ibrahimelgibran.com/" target="_blank" class="text-decoration-none">IegCode</a>. All rights reserved.
            </div>
        </div>
    </footer>
